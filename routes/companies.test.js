...
describe("GET /companies", function () {
  ...
  test("works with/validates correct filters, set 1 filter minEmployees", async function () {
    const resp = await request(app)
        .get("/companies")
  ...
  test("works with/validates correct filters, set 2 filters minEmployees and maxEmployees", async function () {
    const resp = await request(app)
        .get("/companies")
